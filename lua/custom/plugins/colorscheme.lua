return {
  {
    ...
    config = function()
      ...
      local change = Snacks.util.blend('#11111a', '#e8b940', 0.90)
      local delete = Snacks.util.blend('#11111a', '#f82920', 0.90)

      local stagedAdd = Snacks.util.blend('#020207', '#78b957', 0.91)
      local stagedChange = Snacks.util.blend('#020207', '#e8b940', 0.91)
      local stagedDelete = Snacks.util.blend('#020207', '#f82920', 0.91)
      ...
      vim.api.nvim_set_hl(0, 'GitSignsUntracked', { bg = '#ff0000' })

      vim.api.nvim_set_hl(0, 'GitSignsStagedAddNr', { fg = '#585858', bg = stagedAdd })
      vim.api.nvim_set_hl(0, 'GitSignsStagedChangeNr', { fg = '#585858', bg = stagedChange })
      vim.api.nvim_set_hl(0, 'GitSignsStagedDeleteNr', { fg = '#585858', bg = stagedDelete })
